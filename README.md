...
㊗️ **[Hiragana Teacher](https://github.com/sechkarev/KMPHiraganaTeacher)** – my passion project: a mobile app (Android & iOS) that teaches the basics of Japanese in a playful and inspirational manner. Currently in development. Tech stack: **Kotlin, KMP, Swift, Compose Multiplatform, Google ML Kit**. I own the project end-to-end – from making product decisions to refining architecture and adding content.

🎮 **[Stopgate](https://store.steampowered.com/app/1376420/StopGate/)** – a comedy PC game I was the main programmer of (the team comprised about 10 people). Tech stack: **Unity, C#, [Fungus](https://github.com/snozbot/fungus)**. 500+ reviews on Steam, 91% positive.

## Smaller Games

🏓 **[Ergodic Pong Review](https://ultra-v1olence.itch.io/ergodic-pong-review)** – my attempt to create an [ergodic literary work](https://en.wikipedia.org/wiki/Ergodic_literature): it's a text about the videogame Pong, and you have to play Pong while reading it, so the longer you stay in the game the more you get to learn. Tech stack: **Unity, C#**. Source code available [here](https://github.com/sechkarev/PongReview).
...
I'm looking for opportunities in mobile development where I could create something meaningful 🌱
